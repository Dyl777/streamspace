...
-  TODO: Formal heartbeat schema with protocol_version (Issue #215)
-  TODO: Capacity reporting (active_sessions, max_sessions, cpu, memory)
-  TODO: Status transitions (online/degraded/offline) with thresholds
-  TODO: Metrics and alerts for stale agents
